...
{
    /// <inheritdoc />
    public partial class RemoveStoreLocations : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrandId = table.Column<int>(type: "INTEGER", nullable: false),
                    CategoryId = table.Column<int>(type: "INTEGER", nullable: false),
                    Flavor = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    Size = table.Column<string>(type: "TEXT", maxLength: 50, nullable: true),
                    UnitOfMeasure = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_DepartmentId_CategoryName",
                table: "Categories",
                columns: new[] { "DepartmentId", "CategoryName" },
                unique: true);
